...
ダッシュボードの右下にある米国株のテーマ別騰落で、1か月間のパフォーマンス上位5つのテーマについて、Alfredで米国と日本の企業をそれぞれ3社ずつ挙げさせました。
（指示の際に上場企業に絞っていないのでJAXAも入っています。また、この段階では財務状況などは加味していません。）
...
以下、各テーマに関連する米国と日本の企業を各3社ずつリストアップします。
...
米国で注目されている、値上がりしているテーマに基づいて、米国および日本で関連する銘柄を見つけるという使い方です。思いがけないテーマが出てくることもあり、AI関連やデータセンター関連以外の銘柄探しにも展開できます。

## このユースケースで確認できること

市場で強いテーマを起点にし、そのテーマを具体的な米国・日本の企業候補へ落とし込む流れを確認できます。元の質問をそのまま使うだけでなく、上場企業のみ、財務条件、時価総額、地域などを条件に追加して投資ユニバースを絞ることもできます。
