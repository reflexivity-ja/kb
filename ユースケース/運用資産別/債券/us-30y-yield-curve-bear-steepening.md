...
30年金利が上昇したという事実だけでは、それが政策金利見通しの変化なのか、財政・国債需給・インフレ・タームプレミアムなど長期ゾーン固有の要因なのかを切り分けられません。

そこで、まず各年限の金利変化を並べて「どの部分が動いているのか」を確認し、次にイールドカーブの形状を見ます。そのうえで過去の利上げ・利下げ局面と比較し、今回の動きが通常の政策サイクルと同じなのか、それとも異なる要因で生じているのかを確かめます。
...
現在と3ヶ月前の米国債イールドカーブを比較すると、長期ゾーンの持ち上がりが確認できます。
...
ここまでで、直近の動きが長期ゾーン主導であることが確認できました。次に知りたいのは、この動きが通常の金融政策サイクルでも見られるものなのか、それとも今回は財政・需給・タームプレミアムなど別の要因が強いのか、という点です。そのため、過去の利上げ・利下げ局面と比較します。
...
> **読み方の注意:** 前半の「ベア・スティープニング」は直近1〜3ヶ月の年限別変化、とくに超長期ゾーンの持ち上がりを見ています。一方、フォローアップの「ベア・フラット化」は、より長い政策局面と2s10sを使った比較です。観測期間とカーブの測り方が異なるため、同じ市場局面でもラベルが異なり得ます。
...
この分析の狙いは、30年金利の上昇を単独の数字として見るのではなく、どの年限が動いているか、政策金利とどの程度連動しているか、過去の政策局面と何が違うかを順番に切り分けることです。今回のように政策金利が動いていないのに長期金利が上昇している場合、次に見るべき変数は財政・国債需給・インフレ期待・タームプレミアムです。
